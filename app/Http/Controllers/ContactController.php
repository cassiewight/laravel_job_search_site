...
class ContactController extends Controller
{
    ...
    public function update(Contact $contact, SaveRepliedRequest $request)
    {
        ...
        return redirect()->route('contacts.index', $contact)->with('status', 'The request of '.$contact->name .' has been replied.');
    }
    ...
    public function showContactRequest(Contact $contact)
    {
        ...
        return view('contacts.showContactRequest', [
            'contact' => $contact
        ]);
    }
    ...
    public function destroy(Contact $contact)
    {
        ...
        return redirect()->route('contacts.index', $contact)->with('status', 'The message from '.$contact->name .' was deleted successfuly.');
    }
}
